import { WebSocketDataType, type BinaryWebSocketResponse, type IWebSocketClient, type JsonWebSocketResponse, type PlainTextWebSocketMessage, type WebSocketMessage, type WebSocketResponse } from 'foundation/core/system/io/ws/IWebSocketClient';
...
export class WebSocketClientService implements IWebSocketClient {
    ...
    #socket: Socket;
    #responseSubject: Subject<WebSocketResponse>;

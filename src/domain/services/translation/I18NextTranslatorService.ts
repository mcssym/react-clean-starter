...
import { type ICookieStorage } from 'foundation/core/system/io/storage/ICookieStorage';
import { type ITranslationProvider } from 'foundation/core/system/translation/ITranslationProvider';
import { TranslatorService } from 'foundation/core/system/translation/TranslatorService';
...
export class I18NextTranslatorService extends TranslatorService {
    ...
    override of(namespace?: string | undefined, locale?: string | undefined): ITranslationProvider {
        return {
    ...
    async initialize(): Promise<void> {
        ...
        await i18n.init({
            ...
            lng: locale != null ? locale : undefined,
